 ...
 * 
 */
public class A05MultipleLeftRotations {
	 ...
	 *             the from of a matrix where ith row represents the rotated array
	 ...
	 *             Problem Constraints
	 * 
	 *             1 <= length of both arrays <= 2000 -10^9 <= A[i] <= 10^9 0 <=
	 *             B[i] <= 2000
	 * 
	 * 
	 *             Input Format
	 * 
	 *             The first argument given is the integer array A. The second
